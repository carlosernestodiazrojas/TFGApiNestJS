...
import { IHoaMeetingRepository } from 'src/application/repository-interfaces/ihoa-meeting.repository-interface';
import { HoaMeeting } from '../entities/hoa_meeting.entity';
import { HoaMeetingVM } from 'src/adapters/vm/hoa-meeting.vm';
