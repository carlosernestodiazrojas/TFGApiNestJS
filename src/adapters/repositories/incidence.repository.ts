...
import { IIncidenceRepository } from 'src/application/repository-interfaces/iincidence.repository-interface';
import { Incidence } from '../entities/incidence.entity';
import { IncidenceVM } from 'src/adapters/vm/incidence.vm';
