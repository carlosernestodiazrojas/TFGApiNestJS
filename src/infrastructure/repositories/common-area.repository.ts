...
import { ICommonAreaRepository } from 'src/domain/repository-interfaces/icommon-area.repository-interface';
...
export class CommonAreaRepository implements ICommonAreaRepository {
    ...
    async create(dto: CreateCommonAreaDtoInterface): Promise<CommonAreaVM> {
    ...
    async update(id: string, dto: UpdateCommonAreaDtoInterface): Promise<CommonAreaVM> {
